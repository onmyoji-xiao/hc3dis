...
class ScanNetPPDataset:
    def __init__(self, args) -> None:
        ...
        self.root = f'{args.root}/{args.seq_name}'
    ...
    def get_intrinsics(self, frame_id):
        ...
        intrinisc_cam_parameters.set_intrinsics(self.image_size[0], self.image_size[1], intrinsic_matrix[0, 0],
                                                intrinsic_matrix[1, 1], intrinsic_matrix[0, 2], intrinsic_matrix[1, 2])
